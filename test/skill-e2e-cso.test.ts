...
- Save the report to .pstack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.pstack', 'security-reports');
...
- Skip the preamble (pstack-update-check, telemetry, etc.) — go straight to the audit.

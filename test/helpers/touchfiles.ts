...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'codex-review-findings': ['review/**', '.agents/skills/pstack-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'gemini-review-findings': ['review/**', '.agents/skills/pstack-review/**', 'test/helpers/gemini-session-runner.ts', 'lib/worktree.ts'],


  // Coverage audit (shared fixture) + triage + gates
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/pstack-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/pstack-repo-mode'],
  ...
  // pstack-upgrade
  'pstack-upgrade-happy-path': ['pstack-upgrade/**'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  // pstack-upgrade
  'pstack-upgrade-happy-path': 'gate',

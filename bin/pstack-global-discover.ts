#!/usr/bin/env bun
/**
 * pstack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   pstack-global-discover --since 7d [--format json|summary]
 *   pstack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: pstack-global-discover --since <window> [--format json|summary]
...
Examples:
  pstack-global-discover --since 7d
  pstack-global-discover --since 14d --format summary`);
}
...
function resolveClaudeCodeCwd(
  ...
  // e.g., -Users-pawan-git-repo → /Users/pawan/git/repo

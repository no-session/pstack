# Design System — pstack

## Product Context
- **What this is:** Community website for pstack — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering pstack, existing community members

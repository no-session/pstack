...
Branch: pawan/agent-design-tools
...
5. $D serve writes board HTML with injected __PSTACK_SERVER_URL
...
| HTML injection of server URL | __PSTACK_SERVER_URL check | `serve.test.ts` |
